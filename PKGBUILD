...
validpgpkeys=('2BCCE14F5C6725AA2EA8AEB7B9C9DC824AA5BDD5') # Augie Fackler <raf@durin42.com>
source=("https://www.mercurial-scm.org/release/${pkgname}-${pkgver}.tar.gz"{,.asc}
        'mercurial.profile')
sha256sums=('0f5bf688ba2add6f5db98a633edef43411ecf2c7ada5f2e14b9265820a96cd48'
            'SKIP'
